    ...
    <>
      ...
      <motion.div
        ...
        style={{
          ...
          background:
            "linear-gradient(to bottom, rgb(139, 92, 246), rgb(139, 92, 246))",
          boxShadow:
            "0 0 20px rgb(139, 92, 246), 0 0 40px rgb(139, 92, 246), 0 0 60px rgb(139, 92, 246), 0 0 80px rgb(139, 92, 246)",
        }}
      />
    </>
  );
